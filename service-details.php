...
<body class="custom-cursor">
        ...
        <div class="container-fluid">
            <div class="topbar-one-inner">
                <ul class="topbar-left-one">
                    ...
                    <li>
                        <img src="assets/images/svg/header/location.svg" alt="icon">
                ...
                <div class="topbar-right-one">
                    ...
                    <ul class="topbar-social-media-one">
                        <li><a href="https://www.instagram.com/"><img src="assets/images/svg/header/Insta.svg"
                                    alt="icon"></a></li>
                        <li><a href="https://www.facebook.com/"><img src="assets/images/svg/header/Fb.svg"
                                    alt="icon"></a></li>
                        <li><a href="https://x.com/"><img src="assets/images/svg/header/Twiter.svg" alt="icon"></a></li>
                        <li><a href="https://www.pinterest.com/"><img src="assets/images/svg/header/Pintrest.svg"
                                    alt="icon"></a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="main-menu-inner">
                    <ul class="main-menu-list">
                        ...
                        <li class="menu-item-children"><a href="#">Services</a><i class="fa-solid fa-chevron-down"></i>
                            <ul>
                                <li><a href="#">Furniture and Fitouts</a></li>
                                <li><a href="#">IT Hardware</a></li>
                                <li><a href="#">Plant and Machinery</a></li>
                                <li><a href="#">Medical Equipment</a></li>
                                <li><a href="#">Retail Store and Assets</a></li>
                                <li><a href="#">Security/Surveillance Assets</a></li>
                                <li><a href="#">Construction Assets</a></li>
                                <li><a href="#">Transportation Assets</a></li>
                            </ul>
                        </li>
    ...
    <!-- header end -->
    <!-- page header start -->
    <div class="page-header-section" style="background-image: url(assets/images/background/service-page-bg.jpg);">
        <div class="container">
            <div class="row">
            ...
            <div class="row gutter-x-15 gutter-y-30">
                <div class="col-lg-8">
                    <div class="service-details-block animate fadeInLeft wow" data-wow-duration="1500ms" data-wow-delay="200ms">
                        ...
                        <p>Lesse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                            laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                    <div class="service-details-cta animate fadeInLeft wow" data-wow-duration="1500ms" data-wow-delay="400ms">
                        <p class="lead-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                    ...
                    <div class="service-details-block animate fadeInLeft wow" data-wow-duration="1500ms" data-wow-delay="600ms">
                        <img src="assets/images/services/service-detail-1.jpg" alt="services-image">
                    </div>
                    ...
                    <div class="service-details-block animate fadeInLeft wow" data-wow-duration="1500ms" data-wow-delay="1400ms">
                        <div class="service-details-image">
                            <div class="service-details-image-inner">
                                <img class="img-fluid" src="assets/images/services/service-detail-2.jpg"
                                    alt="service-image">
                            </div>
                            <div class="service-details-image-inner">
                                <img class="img-fluid" src="assets/images/services/service-detail-3.jpg"
                                    alt="service-image">
                            </div>
                        </div>
                    </div>
                    <div class="service-details-block animate fadeInLeft wow" data-wow-duration="1500ms" data-wow-delay="1500ms">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                            laboris nisi ut aliquip ex ea commodo consequat.</p>
                    </div>
                    <div class="service-details-block mb-0 animate fadeInLeft wow" data-wow-duration="1500ms" data-wow-delay="1600ms">
                        <div class="service-pagination-list">
                            <div class="service-pagination pre">
                                <div class="service-pagination-inner">
                                    <a href="#"><img src="assets/images/services/service-details-pre.svg" alt="icon">
                            ...
                            <div class="service-pagination next">
                                <div class="service-pagination-inner">
                                    <a href="#"><span>Next</span><img
                                            src="assets/images/services/service-details-next.svg" alt="icon"></a>
                ...
                <div class="col-lg-4">
                    <div class="service-details-sidebar">
                        <div class="service-details-widget animate fadeInRight wow" data-wow-duration="1500ms" data-wow-delay="200ms">
                            ...
                            <ul>
                                <li>
                                    <p>Business Solution</p> <img
                                        src="assets/images/services/service-details-arrow-right.svg" alt="icon">
                                </li>
                                <li>
                                    <p>Strategic Solutions</p> <img
                                        src="assets/images/services/service-details-arrow-right.svg" alt="icon">
                                </li>
                                <li>
                                    <p>Finance Solution</p> <img
                                        src="assets/images/services/service-details-arrow-right.svg" alt="icon">
                                </li>
                                <li>
                                    <p>Investment Policy</p> <img
                                        src="assets/images/services/service-details-arrow-right.svg" alt="icon">
                                </li>
                                <li>
                                    <p>Tax Managment</p> <img
                                        src="assets/images/services/service-details-arrow-right.svg" alt="icon">
                                </li>
                                <li>
                                    <p>Market Research & Analysis</p> <img
                                        src="assets/images/services/service-details-arrow-right.svg" alt="icon">
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row gutter-y-30">
                    <div class="col-xl-4">
                        <div class="footer-about-one animate fadeInRight wow" data-wow-duration="1500ms">
                            ...
                            <h4>Professional & modern, a theme designed to help your business stand out from the rest.
                            </h4>
                            <p class="lead">We understand that business can be chaotic. That’s where we come in. We’re
                                focused on adding.</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget-one animate fadeInRight wow" data-wow-duration="1500ms"
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="footer-newslatter-one animate fadeInRight wow" data-wow-duration="1500ms"
                            ...
                            <form action="#">
                                <div class="newslatter-form-group">
                                    <input type="email" name="email" placeholder="Enter your email" class="form-control"
                                        required="">
                                    <button type="submit" class="btn-link"><img src="assets/images/svg/arrow-link.svg"
                                            alt="icon"></button>
                                </div>
                            </form>
                            <ul class="footer-social-media-one">
                                <li><a href="https://www.facebook.com/"><img src="assets/images/svg/header/Fb.svg"
                                            alt="icon"></a></li>
                                <li><a href="https://x.com/"><img src="assets/images/svg/header/Twiter.svg"
                                            alt="icon"></a>
                                </li>
                                <li><a href="https://www.instagram.com/"><img src="assets/images/svg/header/Insta.svg"
                                            alt="icon"></a></li>
        ...
        <div class="side-menu-content">
            ...
            <div class="side-menu-container">
                ...
                <ul>
                    ...
                    <li>
                        <a href="telto:+120.098.456 11"> +120.098.456 11</a>
                    </li>
                </ul>
                ...
                <ul class="side-menu-social-media">
