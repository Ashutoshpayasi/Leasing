...
<body class="custom-cursor">
        ...
        <div class="col-xl-6">
          <div class="about-right-one">
            ...
            <div
              ...
              <p class="lead">
              <p>Leasegrid is a company decked with veteran professionals who provide unparalleled leasing solutions. We provide complete Aseet Lifecycle Solutions, which are tailored to suit client's requirements.
                No matter what asset class you need to procure,we can assist you by customizing our solutions to help you optimize your cash flow. Whether you are looking for Plant and Machinery, servers ,furniture, electronics devices or any other kind of asset, PAPL can provide it to you on lease.
                PAPL is one of the provider of comprehensive leasing solutions for all your requirement.</p>
  ...
  <!-- patner one start -->
  <div class="patner-section-one">
    <div class="container-fluid p-0">
      <div class="patner-slider-one">
        <div class="patner-slide-item-one">
          <img src="assets/images/patner/patner-1.png" alt="patner-logo" />
        </div>
        <div class="patner-slide-item-one">
          <img src="assets/images/patner/patner-2.png" alt="patner-logo" />
        </div>
        <div class="patner-slide-item-one">
          <img src="assets/images/patner/patner-3.png" alt="patner-logo" />
        </div>
        <div class="patner-slide-item-one">
          <img src="assets/images/patner/patner-4.png" alt="patner-logo" />
        </div>
        <div class="patner-slide-item-one">
          <img src="assets/images/patner/patner-5.png" alt="patner-logo" />
        </div>
        <div class="patner-slide-item-one">
          <img src="assets/images/patner/patner-1.png" alt="patner-logo" />
        </div>
          ...
          <div class="service-right-one">
            <div class="service-right-inner-one">
              <div
                ...
                <p>
                  Get the latest equipment for your business without the large
                  capital investment.
                </p>
                <a href="service-details.php" class="service-btn-one"><i class="fa-solid fa-angle-right"></i></a>
              </div>
              <div
                class="service-box-one animate fadeInUp wow"
                data-wow-duration="1500ms"
                ...
                <p>
                  Flexible and cost-effective vehicle leasing for your entire
                  fleet, from cars to commercial trucks.
                </p>
                <a href="service-details.php" class="service-btn-one"><i class="fa-solid fa-angle-right"></i></a>
              </div>
            </div>
