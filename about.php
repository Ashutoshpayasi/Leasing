    ...
    <section class="about-main-section" style="padding: 50px 0 30px 0; background: #f9f9fb;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <h3 style="color: #581c87; margin-bottom: 18px;">Our Story</h3>
            ...
            <div class="row text-center">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="about-box" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 12px #eee; padding: 30px 20px; height: 100%;">
                        <h3 style="color: #a855f7;">Vision</h3>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="about-box" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 12px #eee; padding: 30px 20px; height: 100%;">
                        ...
                        <p>Connect Lease goal is to lead the industry by offering a wide range of efficient products that are suitable and affordable. The company aims to add value and lower the cost of its business partners by covering all aspects of the leasing solutions.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="about-box" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 12px #eee; padding: 30px 20px; height: 100%;">
                        <h3 style="color: #a855f7;">Goal</h3>
                        <p>To become the industry's leading provider of efficient and affordable products by offering comprehensive leasing solutions. Our aim is to add significant value to our business partners and reduce their costs through an all-encompassing approach.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="entity-box" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 12px #eee; padding: 30px 20px;">
                        <h4 style="color: #581c87;">Leasegrid Connect Private Limited</h4>
                        <p>Engaged into leasing of Vehicle and Equipment.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="entity-box" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 12px #eee; padding: 30px 20px;">
                        <h4 style="color: #581c87;">Leasegrid Advisors LLP</h4>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="asset-box" style="background: #fff; border-radius: 12px; box-shadow: 0 2px 12px #eee; padding: 30px 20px; text-align: center;">
                        <h4 style="color: #a855f7;">Leasegrid</h4>
                ...
                <div class="col-xl-6">
                    <div class="about-right-one">
                        ...
                        <div class="about-details-one animate fadeInUp wow" data-wow-duration="1500ms" data-wow-delay="300ms">
                            <p class="lead">We offer a wide range of specialised leasing solutions to meet the Leasegridue needs of your business. Explore the benefits of our leasing programs and discover how we can help you achieve your financial goals.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="heading-box light text-center">
                        <span class="sub-title animate fadeInUp wow" data-wow-duration="1500ms">Why Choos Us</span>
